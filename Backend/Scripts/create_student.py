#!/usr/bin/env python
"""
Interactive script to create a student account for Capital Mathematics Studies LMS.
"""
...
def main():
    ...
    print("=" * 80)
    print("Capital Mathematics Studies - Student Account Creation")
    print("=" * 80)
    print()
    ...
    try:
        ...
        print()
        print("The student can now login using:")
        print(f"  - Email: {email}")
