      ...
      <div className="min-h-screen">
        ...
        <main className="px-6 py-8">
          <div className="bg-white rounded-lg shadow-md p-8">
            <div className="text-center">
              <p className="text-gray-600 mb-4">My Classes feature coming soon!</p>
              <p className="text-sm text-gray-500">You'll be able to view and manage your classes here.</p>
            </div>
          </div>
        </main>
      </div>
